const stripe = require("stripe")(
  "sk_test_51QFG6SRsLyr6WwcbLgwLURohiRZbgq0AJv35ZSmnxJoxbQFfWCKs63inmXKYv2T7lsolsyWaZntAodF9spCevW2a00dUlVFAlF"
  ...
  try {
    ...
    const lineItems = items.map((item) => ({
      price_data: {
        ...
        unit_amount: item.price, // Stripe utilise des centimes
      },
    ...
    res
      ...
      .json({
        error:
          "Une erreur est survenue lors de la création de la session de checkout.",
      });
  }
};
